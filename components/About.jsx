    ...
    <div className=' w-3/4 m-auto  pt-28 mb-56' id="about">
      <div className='flex justify-between  flex-wrap'>
        <div className=' w-2/3 '>
          ...
          I develop many types of frontends by native Javascript, React and Next,
          I passionate to do more and more.   <br/> <br/>
          I capable to use many technologies to develop front end web application, I studied front end for two years and aspiring to be a senior. </p>
